...
public class SETStockEOD {
    ...
    public static void main(String[] args) {
        ...
        for (String sector:SECTORS) {
            ...
            String url = "https://www.set.or.th/en/market/index/set/" + sector;
            ...
            int factoryTablesSize = tables.get(0).findElements(By.cssSelector("tr")).size() - 2;
            ...
            try {
                try {
                    ...
                    for (int factoryTableNo = 0; factoryTableNo < factoryTablesSize; ++factoryTableNo) {
                        List<WebElement> elements = driver.findElements(By.cssSelector("tr[id$='-group-row-accordion-children-0-" + factoryTableNo + "']"));
                        for (int trNo = 0; trNo < elements.size(); trNo++) {

                            List<WebElement> c = elements.get(trNo).findElements(By.xpath("./child::*"));
